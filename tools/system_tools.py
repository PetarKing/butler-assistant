            ...
            messages=[
                {
                    ...
                    "content": [
                        ...
                        {"type": "text", "text": "Describe what you are seeing on the user's screen. Extract all visible text, plus visual/conceptual items, in a way that is easy to reference or talk about. If there are no visible items, say so."}
                    ],
                }
            ],
            max_tokens=1000,
                ...
                messages=[
                    {
                        ...
                        "content": [
                            {"type": "image_url", "image_url": {"url": f"data:image/png;base64,{b64}"}},
                            {"type": "text", "text": "Describe this clipboard image in 5 concise bullet points."}
                        ],
                    }
                ],
                max_tokens=1000,
